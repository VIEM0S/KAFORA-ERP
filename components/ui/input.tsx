  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          // text-base (16px) sur mobile : en dessous de 16px, Safari/Chrome
          // iOS zooment automatiquement la page au focus d'un champ — c'est
          // ce zoom-là qui obligeait à dézoomer soi-même après chaque saisie
          // (login, formulaires...). text-sm (14px) réservé au desktop.
