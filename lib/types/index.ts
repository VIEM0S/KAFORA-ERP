...
export type AlertType = 'LOW_STOCK' | 'OUT_OF_STOCK' | 'OVERDUE_CREDIT' | 'LARGE_DISCOUNT' | 'REFUND' | 'CASH_VARIANCE' | 'FAILED_PAYMENT' | 'SUSPICIOUS_ACTIVITY' | 'OFFLINE_SYNC_CONFLICT' | 'USER_DELETION_REQUEST' | 'USER_DELETION_RESOLVED' | 'CREDIT_WRITTEN_OFF' | 'CREDIT_WRITE_OFF_PENDING' | 'CREDIT_LIMIT_CHANGED' | 'SUPPORT_TICKET_REPLY' | 'SUBSCRIPTION_SUSPENDED' | 'SUBSCRIPTION_REACTIVATED' | 'SUBSCRIPTION_EXTENDED' | 'KAFORA_ANNOUNCEMENT' | 'SUBSCRIPTION_EXPIRING_SOON';
